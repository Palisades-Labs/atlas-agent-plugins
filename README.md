...
| Agent | How |
|---|---|
| **Claude Code** | `/plugin marketplace add Palisades-Labs/atlas-agent-plugins@atlas--v0.1.6` then `/plugin install atlas@atlas-plugins` |
| **Codex** | `codex plugin marketplace add Palisades-Labs/atlas-agent-plugins --ref atlas--v0.1.6` then `codex plugin add atlas@atlas-plugins` |
| **Cursor** | Install the immutable `atlas--v0.1.6` release from Cursor Marketplace once listed; Team/Enterprise admins can import that tagged GitHub release from Dashboard → Plugins |
